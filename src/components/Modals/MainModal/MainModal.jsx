...
const MainModal = () => {
    ...
    return (
        <div className="bg-slate-900 h-screen overflow-y-scroll snap-y snap-mandatory hide-scrollbar items-center justify-center">
            ...
            <div className="min-h-screen xl:h-screen flex items-center justify-center snap-start" ref={skillsRef}>
                <Skills />
            </div>
            <div className="min-h-screen xl:h-screen flex items-center justify-center snap-start" ref={portfolioRef}>
                <Portfolio />
            </div>
            <div className="min-h-screen xl:h-screen flex items-center justify-center snap-start bottom-0" ref={contactRef}>
                <Contact />
            </div>
