...
const MainModal = () => {
    ...
    const [isMobileMenuOpen, setMobileMenuOpen] = useState(false);  // Ensure this state is defined
    ...
    return (
        <div className="bg-slate-900 h-screen overflow-y-scroll snap-y snap-mandatory hide-scrollbar items-center justify-center">
            ...
            <div className="fixed top-0 left-0 w-full justify-between items-center p-4 show-on-mobile hide-on-desktop">
                ...
                <button onClick={() => setMobileMenuOpen(!isMobileMenuOpen)} className="text-white fixed text-2xl p-6 top-0 right-0">
                    &#9776;
                </button>
            </div>
            {isMobileMenuOpen && (
