...
const RealCard = ({ realisation, openModal }) => {
  ...
  return (
    <div className="realisation-card cursor-pointer w-40 h-32 md:w-32 md:h-20 xl:w-64 xl:h-48 transition-transform duration-300 ease-in-out transform hover:scale-105" onClick={() => openModal(realisation)}>
