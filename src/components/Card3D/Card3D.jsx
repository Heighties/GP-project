...
const Card3D = () => {
  ...
  return (
    <motion.div
      className="w-96 aspect-card md:w-[600px] md:aspect-card2 xl:w-[800px] xl:aspect-card2 rounded-32 relative overflow-hidden"
      onMouseMove={(e) => {
        if (!cardRef.current || !glareRef.current || isFlipped) return;
        const cardRect = cardRef.current.getBoundingClientRect();
          ...
          <div className="absolute inset-4 bg-white rounded-32 flex flex-col md:flex-row xl:flex-row">
            <div className="h-32 md:h-full md:w-1/2 relative border-4 md:border-none border-white rounded-32 md:rounded-32-tl-bl custom-shape flex justify-center items-center">
              ...
              <div className="md:p-4 absolute md:top-0 md:left-0 md:w-full md:h-full flex justify-center md:justify-start items-center">
                <svg
                  className="w-28 h-28 xl:w-56 xl:h-56"
                  viewBox="0 0 100 137"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    d="M97 51.4681C97 77.1015 75.9877 97.9362 50 97.9362C24.0123 97.9362 3 77.1015 3 51.4681C3 25.8346 24.0123 5 50 5C75.9877 5 97 25.8346 97 51.4681Z"
                    fill="white"
                    fillOpacity="0.7"
                    stroke="black"
                    strokeWidth="6"
