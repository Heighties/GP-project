...
const Skills = () => {
  return (
    <div className='flex flex-col items-center w-full h-screen xl:h-full xl:gap-10'>
      ...
      <div className='items-center xl:items-stretch flex flex-col xl:flex-row w-full xl:w-2/3 xl:h-2/3 mt-4 xl:mt-0 xl:gap-10'>
        ...
        <div className='bg-slate-800 border-4 border-white w-3/4 xl:w-1/3 rounded-32 flex flex-col items-center p-2 xl:p-0'>
          ...
          <div className='grid grid-cols-3 xl:gap-10 mt-2 xl:mt-10'>
            ...
            <div className='flex flex-col items-center'>
              <FaCss3Alt className="text-white text-2xl xl:text-4xl" />
              <span className='text-white text-sm'>CSS</span>
            </div>
            <div className='flex flex-col items-center'>
              <FaJs className="text-white text-2xl xl:text-4xl" />
              <span className='text-white text-sm'>JavaScript</span>
            </div>
            <div className='flex flex-col items-center'>
              <DiSass className="text-white text-2xl xl:text-4xl" />
              <span className='text-white text-sm'>SCSS</span>
            </div>
            <div className='flex flex-col items-center'>
              <FaReact className="text-white text-2xl xl:text-4xl" />
              <span className='text-white text-sm'>React</span>
            </div>
            <div className='flex flex-col items-center'>
              <SiTailwindcss className="text-white text-2xl xl:text-4xl" />
        ...
        <div className='bg-slate-800 border-4 border-white w-3/4 xl:w-1/3 h-full rounded-32 flex flex-col items-center mt-2 xl:mt-0 p-2 xl:p-0'>
          ...
          <div className='flex flex-row xl:grid xl:grid-cols-2 gap-4 xl:gap-16 mt-2 xl:mt-10'>
            ...
            <div className='flex flex-col items-center'>
              <SiStrapi className="text-white text-2xl xl:text-4xl" />
              <span className='text-white text-sm'>Strapi</span>
            </div>
            <div className='flex flex-col items-center'>
              <AiOutlineConsoleSql className="text-white text-2xl xl:text-4xl" />
              <span className='text-white text-sm'>SQL</span>
            </div>
            <div className='flex flex-col items-center'>
              <SiMongodb className="text-white text-2xl xl:text-4xl" />
        ...
        <div className='flex flex-col w-3/4 xl:w-1/3 xl:gap-10 p-2 xl:p-0'>
          <div className='bg-slate-800 border-4 border-white w-full xl:w-full xl:h-1/2 rounded-32 flex flex-col items-center p-2 xl:p-0'>
            ...
            <div className='flex flex-wrap justify-center items-center xl:gap-10 mt-2 xl:mt-4'>
              ...
              <div className='flex flex-col items-center'>
                <SiFramer className="text-white text-2xl ml-10 xl:ml-0 xl:text-4xl" />
                <span className='text-white text-sm ml-10 xl:ml-0'>Framer Motion</span>
              </div>
            </div>
          </div>
          <div className='bg-slate-800 border-4 border-white w-full xl:h-1/2 rounded-32 flex flex-col items-center mt-2 xl:mt-0 p-2 xl:p-0'>
            <h2 className='text-white xl:text-2xl xl:mt-2'>Divers</h2>
            <div className='flex flex-wrap justify-center ml-8 gap-4 xl:gap-10 mt-2 xl:mt-4'>
              <div className='flex flex-col items-center'>
                <FaGitAlt className="text-white text-2xl xl:text-4xl" />
                <span className='text-white text-sm '>Git</span>
              </div>
              <div className='flex flex-col items-center'>
                <FaGithub className="text-white text-2xl xl:text-4xl" />
                <span className='text-white text-sm'>GitHub</span>
              </div>
              <div className='flex flex-col items-center'>
                <SiPowershell className="text-white text-2xl xl:text-4xl" />
      ...
      <div className='text-white rounded-lg w-full h-1/5 xl:h-1/3 flex justify-center items-center bg-fixed bg-cover bg-parallax mt-2 mb-10 xl:mt-0'>
