        ...
        <form className='flex flex-col items-center' onSubmit={handleSubmit}>
          <div className='flex flex-col items-center xl:flex-row w-full h-full xl:gap-24'>
            <div className='flex flex-col w-3/4 xl:w-1/2 gap-2'>
              <div className='flex flex-row gap-4'>
                <div className="w-1/2">
                  ...
                  <input type="text" id="firstName" name="firstName" className="w-full border border-gray-300 rounded-md xl:py-2 px-3" onChange={handleChange} />
                </div>
                <div className="w-1/2">
                  <label htmlFor="lastName" className="block text-white text-sm font-semibold mb-1">Nom</label>
                  <input type="text" id="lastName" name="lastName" className="w-full border border-gray-300 rounded-md xl:py-2 px-3" onChange={handleChange} />
                </div>
              </div>
              <div className="w-full">
                <label htmlFor="email" className="block text-white text-sm font-semibold mb-1">E-mail</label>
                <input type="email" id="email" name="email" className="w-full border border-gray-300 rounded-md xl:py-2 px-3" onChange={handleChange} />
              </div>
              <div className="w-full">
                <label htmlFor="subject" className="block text-white text-sm font-semibold mb-1">Objet</label>
                <input type="text" id="subject" name="subject" className="w-full border border-gray-300 rounded-md xl:py-2 px-3" onChange={handleChange} />
              </div>
            </div>
            <div className="w-3/4 h-32 xl:w-1/2 xl:h-[198px]">
              ...
              <textarea id="message" name="message" className="w-full h-full border border-gray-300 rounded-md resize-none" rows="10" onChange={handleChange}></textarea>
            </div>
          </div>
